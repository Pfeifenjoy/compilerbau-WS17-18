...
code2BS (Aload ind :xs) = 0x19 `BS.cons` ind `BS.cons` code2BS xs
code2BS (Invokespecial ind1 ind2 :xs) = 0xb7 `BS.cons` ind1 `BS.cons` ind2 
                                             `BS.cons` code2BS xs
...
code2BS (Bipush ind :xs) =  0x10 `BS.cons` ind `BS.cons` code2BS xs
code2BS (Putfield  b1 b2:xs) = 0xb5 `BS.cons` b1 `BS.cons` b2 
                                    `BS.cons` code2BS xs
code2BS (Getfield  b1 b2:xs) = 0xb4 `BS.cons` b1 `BS.cons` b2 
                                    `BS.cons` code2BS xs
...
code2BS (IStore ind:xs) = 0x36 `BS.cons` ind `BS.cons` code2BS xs
code2BS (Iinc ind con:xs) = 0x84 `BS.cons` ind `BS.cons` con 
                                 `BS.cons` code2BS xs
code2BS (New  ind1 ind2:xs) = 0xbb `BS.cons` ind1 `BS.cons` ind2 
                                   `BS.cons` code2BS xs
...
code2BS (Astore ind :xs) = 0x3a `BS.cons` ind `BS.cons` code2BS xs
...
code2BS (Iload ind :xs) = 0x15 `BS.cons` ind `BS.cons` code2BS xs
code2BS (Invokevirtual ind1 ind2:xs) = 0xb6 `BS.cons` ind1 `BS.cons` ind2 
                                            `BS.cons` code2BS xs
code2BS (Areturn:xs) =  0xb0 `BS.cons` code2BS xs
code2BS (Ireturn:xs) =  0xac `BS.cons` code2BS xs
code2BS (IfIcmpEq b1 b2:xs) = 0x9f `BS.cons` b1 `BS.cons` b2 
                                   `BS.cons` code2BS xs
code2BS (IfIcmpNe b1 b2:xs) = 0xa0 `BS.cons` b1 `BS.cons` b2 
                                   `BS.cons` code2BS xs
code2BS (IfIcmpLt b1 b2:xs) = 0xa1 `BS.cons` b1 `BS.cons` b2 
                                   `BS.cons` code2BS xs
code2BS (IfIcmpGe b1 b2:xs) = 0xa2 `BS.cons` b1 `BS.cons` b2 
                                   `BS.cons` code2BS xs
code2BS (IfIcmpGt b1 b2:xs) = 0xa3 `BS.cons` b1 `BS.cons` b2 
                                   `BS.cons` code2BS xs
code2BS (IfIcmpLe b1 b2:xs) = 0xa4 `BS.cons` b1 `BS.cons` b2 
                                   `BS.cons` code2BS xs
