ClassFile {
                 ...
                 count_cp = 13,
                 array_cp = [
                     MethodRef_Info {tag_cp = TagMethodRef, index_name_cp = 3, index_nameandtype_cp = 10, desc = ""},
                     Class_Info {tag_cp = TagClass, index_cp = 11, desc = ""},
                     ...
                     Utf8_Info {tag_cp = TagUtf8, tam_cp = 10, cad_cp = "empty.java", desc = ""},
                ...
                array_methods = [
                     Method_Info { af_mi = AccessFlags [],
                                   ...
                                   array_attr_mi = [AttributeCode {
                                                       ...
                                                       array_ex_attr = [],
                                                       tam_atrr_attr = 1,
                                                       array_attr_attr = [AttributeLineNumberTable {
                                                                             index_name_attr = 7,
                                                                             tam_len_attr = 6,
                                                                             tam_table_attr = 1,
                                                                             array_line_attr = [(0,1)]}]}]}],
                                                                             count_attributes = 1,
                                                                             array_attributes = [AttributeSourceFile {
                                                                                                    index_name_attr = 8,
                                                                                                    tam_len_attr = 2,
                                                                                                    index_src_attr = 9}]}